...
class Network(torch.nn.Module):
    ...
    **Example:**
    ...
    def forward_bad_zeros(self):
        # language=rst
        """
        Dummy-implementation for single simulation step. Does not perform no network activity whatsoever
        (i.e. leaves all spikes to be zero for ever)
        """
        # print("bad 0, bad 0, bad 0!")
